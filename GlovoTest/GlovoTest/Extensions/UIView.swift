...
// MARK: - Snapkit
extension UIView {
    var safeOrBottom: ConstraintRelatableTarget {
    ...
    var safeOrTop: ConstraintRelatableTarget {
        if #available(iOS 11.0, *) {
    ...
    var safeOrLeft: ConstraintRelatableTarget {
        if #available(iOS 11.0, *) {
    ...
    var safeOrRight: ConstraintRelatableTarget {
        if #available(iOS 11.0, *) {
